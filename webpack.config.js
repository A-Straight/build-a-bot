{
  mode: 'production',
  context: 'C:\\Development\\VueDevelopment\\build-a-bot',
  devtool: 'source-map',
  output: {
    hashFunction: 'xxhash64',
    path: 'C:\\Development\\VueDevelopment\\build-a-bot\\dist',
  ...
  resolve: {
    alias: {
      '@': 'C:\\Development\\VueDevelopment\\build-a-bot\\src',
    ...
    modules: [
      'node_modules',
      'C:\\Development\\VueDevelopment\\build-a-bot\\node_modules',
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'C:\\Development\\VueDevelopment\\build-a-bot\\node_modules\\vue-loader\\dist\\index.js',
            options: {
              cacheDirectory: 'C:\\Development\\VueDevelopment\\build-a-bot\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '63a1b7be',
              babelParserPlugins: [
                'jsx',
                'classProperties',
                'decorators-legacy'
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'C:\\Development\\VueDevelopment\\build-a-bot\\public\\index.html'
      }
    ),
    /* config.plugin('copy') */
    new CopyPlugin(
      {
        patterns: [
          {
            from: 'C:\\Development\\VueDevelopment\\build-a-bot\\public',
            to: 'C:\\Development\\VueDevelopment\\build-a-bot\\dist',
            toType: 'dir',
            noErrorOnMissing: true,
            globOptions: {
              ignore: [
                '**/.DS_Store',
                'C:/Development/VueDevelopment/build-a-bot/public/index.html'
              ]
            },
            info: {
              minimized: true
    ...
    new ESLintWebpackPlugin(
      {
        ...
        cwd: 'C:\\Development\\VueDevelopment\\build-a-bot',
        cache: true,
        cacheLocation: 'C:\\Development\\VueDevelopment\\build-a-bot\\node_modules\\.cache\\eslint\\0eed14ac.json',
        context: 'C:\\Development\\VueDevelopment\\build-a-bot',
        failOnWarning: false,
        failOnError: true,
        eslintPath: 'C:\\Development\\VueDevelopment\\build-a-bot\\node_modules\\eslint',
        formatter: 'stylish'
      }
    )
  ],
